        ...
        <div className="pointer-events-none relative z-10">
          <Reveal>
            <h1 className="pointer-events-auto text-4xl sm:text-6xl font-black text-zinc-100 md:text-8xl">
              We are Aurora<span className="text-indigo-500">.</span>
            </h1>
          </Reveal>
          <Reveal>
          ...
          <Reveal>
            <p className="pointer-events-auto leading-relaxed md:leading-relaxed max-w-xl text-sm text-zinc-300 md:text-base">
              We specialize in creating exceptional digital experiences - from mobile apps to AI solutions.
              Our team has delivered successful projects across the MENA region and beyond. Let's build something amazing together.
            </p>
          </Reveal>
          <Reveal>
            <OutlineButton
